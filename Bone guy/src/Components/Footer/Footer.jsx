    ...
    <div className="footerdiv">
        ...
        <div>
            <ul>
                ...
                <div>
                <a href="https://www.facebook.com/theboneguy.lb?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer"><img className="facebooklogo" alt="facebook logo" src={facebooklogo}/></a>
                <a href="https://www.instagram.com/theboneguy.lb/" target="_blank" rel="noopener noreferrer"><img className="instagramlogo" alt="instagram logo" src={instagramlogo}/></a>
                </div>
            </ul>
        </div>
        <div>
